...
// const wrapper = document.getElementById('searchWrap');
// const results = document.getElementById('search-results');
// const searchResult = document.getElementById('searchResultsDropdown');
...
//     if(dropdown && !dropdown.contains(event.target) && !dropdown.contains(event.target) )
...
//     isLoading = true;
//     productResultsContainer.innerHTML = '<div class="loading">Loading products...</div>';
//     blogResultsContainer.innerHTML = '<div class="loading">Loading blogs...</div>';
//   }
...
//   if (data.products && data.products.length > 0) {
//     productResultsContainer.innerHTML = data.products.map(product => createProductHTML(product)).join('');
//   } else {
//     productResultsContainer.innerHTML = '<div class="no-results">No products found</div>';
//   }

//   if (data.blogs && data.blogs.length > 0) {
//     blogResultsContainer.innerHTML = data.blogs.map(blog => createBlogHTML(blog)).join('');
//   } else {
//     blogResultsContainer.innerHTML = '<div class="no-results">No blogs found</div>';
//   }
// }
...
//   const images = product.content.product_images || '[]';
//   const imageUrl = images.length > 0 ? `storage/${images[0].product_image}` : '';
//   const description = stripTags(product.content.product_desc || '').substring(0, 15) + '...';
...
//   let imageUrl = '';
//   const description = stripTags(blog.body || '').substring(0, 25) +'...';
...
//         </div>
//         <div class="result-info">
//           <h4>${stripTags(blog.title || '').substring(0, 15) +'...'}</h4>
//           <p>${escapeHTML(description)}</p>
//         </div>
//       </a>
//     </div>
...
//   productResultsContainer.innerHTML = '<div class="error">Failed to load products. Please try again.</div>';
//   blogResultsContainer.innerHTML = '<div class="error">Failed to load blogs. Please try again.</div>';
// }
