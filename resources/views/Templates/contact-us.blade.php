                ...
                <div class="col-md-12 col-lg-9">
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-md-5 d-none d-md-block">
                            <div class="contact-box p-3 py-4 shadow-sm rounded-4">
                                <div class="d-flex align-items-start">
                                    <i class="fa fa-map-marker fs-4 me-2"></i>
                                    <div>
                                        <h5 class="fw-bold mb-1">HEAD OFFICE ADDRESS:</h5>
                                        <p class="mb-0">
                            ...
                            <div class="contact-box p-3 py-4 shadow-sm rounded-4 mt-3">
                                <div class="d-flex align-items-start">
                                    <i class="fa fa-map-marker fs-4 me-2"></i>
                                    <div>
                                        <h5 class="fw-bold mb-1">MANUFACTURING & RESEARCH CENTER:</h5>
                                        <p class="mb-0">
                            ...
                            <div class="contact-box p-3 py-4 shadow-sm rounded-4 mt-3">
                                <div class="d-flex align-items-start">
                                    <i class="fa fa-envelope-o fs-4 me-2 ms-0"></i>
                                    <div class="ms-0">
