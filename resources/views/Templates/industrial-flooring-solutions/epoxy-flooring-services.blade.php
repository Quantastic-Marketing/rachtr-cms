                      ...
                      <div class="content col-md-9">
                          <div class="container">
                              <div class="content-details ms-0">
                                   <h1 class="fw-bold">{!! $banner['heading'] ?? 'Industrial <span>Epoxy</span> flooring Services'!!}</h1>
                                   @if(!empty($banner['subhead']))
                                        {!! $banner['subhead'] !!}
                                   @else
                                        <p>Upgrade your floors with RachTR's high-performance epoxy coatings. Designed for superior strength, chemical resistance, and easy maintenance.</p>
                                   @endif
                              </div>
    ...
    @endif
     ...
     <section class="get-free-quote py-5" style=" background: url({{ !empty($quote['image']) ? asset('storage/' . $quote['image']) : asset('images/get-free-quote-bg.webp')}});">   
        <div class="container">
            <div class="row g-0">
                <div class="col-12">
                    <div class="get-free-content d-flex flex-column">
                        <div class="heading-holder pt-5 text-center">
                            <h2>{!! $quote['heading'] ?? "Don't Wait! Get a Free Quote & <br>
