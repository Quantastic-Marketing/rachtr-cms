<!-- This is a wrapper open -->
    <div class="wrapper">
         @php 
            ...
            $founders = $pageContent['founders'] ?? [];
            $mentors = $pageContent['mentors'] ?? [];
        @endphp
                ...
                <div class="col-lg-12">
                    <div class="banner-section">
                        <div class="image-wrapper">
                            <img src="{{ !empty($banner['banner_image_desktop']) ? asset('storage/' . $banner['banner_image_desktop']) :asset('images/about_Desk_banner.webp') }}" alt="About us banner" class="d-none d-md-block">
                            <img src="{{ !empty($banner['banner_image_mobile']) ? asset('storage/' . $banner['banner_image_mobile']) : asset('images/about_mob_banner.webp') }}" alt="About us banner" class=" d-block d-md-none">
                        </div>
                        <div class="heading-holder">
                            <h1 class="fw-bold">{!! $banner['banner_heading'] ?? 'Revolutionizing Coatings and <br> Adhesives for India' !!}</h1>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="founder-section">
            <div class="container">
                ...
                <div class="row">
                    @forelse($founders['founder'] ?? [] as $founder)
                        <div class="col-12 col-sm-6 col-lg-3 founder-card">
                            <div class="founder-img-container">
                                <img src="{{ asset('storage/' . $founder['image']) }}" alt="{{$founder['name']}}" class="founder-img">
                            </div>
                            ...
                            <div class="hover-content">
                                ...
                                <div class="person-info  justify-content-center text-center align-items-center p-3 pt-3">
                                    <a href="{{$founder['linkedin']}}" class="linkedin-style mb-3"><i class="fa fa-linkedin" aria-hidden="true"></i></a>
                                    <p>{{$founder['bio']}}</p>
                                </div>
                            </div>
                        </div>
        ...
        <section class="mentor-section py-5 text-center">
            <div class="container">
                <h2 class="mentor-title">{{ $mentors['heading'] ?? 'MENTORS'}}</h2>
                
                <div class="row justify-content-center">
                    @forelse($mentors['mentor'] ?? [] as $mentor)
                        <div class="col-md-4 col-sm-10 mentor-card">
                            <div class="mentor-img-container">
                                <img src="{{ asset('storage/' . $mentor['image'] )}}" alt="{{$mentor['name']}}" class="mentor-img">
                            </div>
                            <h3 class="mentor-name">{{$mentor['name']}}</h3>
                            <p class="mentor-details">{{$mentor['details']}}</p>
                            <a href="{{$mentor['linkedin']}}" class="social-icon" aria-label="LinkedIn">
                    ...
                    <div class="col-md-10">
                        <div class="row cta-box g-0  mx-2 my-5 m-sm-5 m-md-0 mb-md-5 p-4 pt-2 gy-4">
                            <div class="col-md-6 d-flex justify-content-center-md align-items-center align-items-start-lg p-lg-5 py-md-4 justify-content-start">
                                <h2 class="cta-text">{!! $pageContent['cta_heading'] ?? 'Get Started with<br>RachTR Today' !!}</h2>
                            </div>
                            <div class="col-md-6 p-md-3 p-lg-5 d-flex text-center justify-content-center-md  align-items-center-md align-items-start">
                                <a href="{{ $pageContent['cta_whatsapp_link'] ?? 'https://api.whatsapp.com/send?phone=917827191824&text=Hey%2C%20greetings%2C%20I%20want%20to%20learn%20more%20about%20your%20business!' }}" class="btn cta-button fw-bold">{!! $pageContent['cta_button_text'] ?? 'SPEAK TO AN EXPERT' !!}</a>
                            </div>
                        </div>
                    </div>
