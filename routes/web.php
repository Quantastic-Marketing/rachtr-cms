...
Route::redirect('product-page/rachtr-xc-3', '/product-page/rachtr-xc-4', 301);
...
Route::redirect('/category/products','/category/product',301);
...
Route::redirect('/post/solutions','/blogs/white-marble-installation-methodology',301);
Route::redirect('/post/epoxyflooringforextremetemperatures','/blogs/cold-storage-refrigeration-facilities-epoxy-flooring-for-extreme-temperatures',301);
Route::get('/post/{slug}', function ($slug) {
    return redirect("/blogs/{$slug}", 301);
});
Route::redirect('/blog', '/blogs', 301);
Route::get('/blog/page/{page}', function ($page) {
    return redirect()->to("/blogs?page={$page}", 301);
});
